...
str_match(x, pattern = "a{2,4}b*c*a?")
```
...
x <- c("1 name available?", "2 names available?", "no names found!",
       "22 names available?")
str_match(x, pattern = "[:digit:]+ \\w{4,5} \\w{9}")
```
